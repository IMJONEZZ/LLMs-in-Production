...
def print_trainable_parameters(model):
    """
    Prints the number of trainable parameters in the Supervised FineTuning model.
    """
    trainable_params = 0
    all_param = 0
...
def build_dataset(
    ...
    """
    Build RL dataset for training. This builds the dataset from `load_dataset`, one should
...
def run_training(train_data, val_data):
    ...
    training_args = TrainingArguments(
        output_dir="./chapters/chapter_4/models/RLHF",
...
if __name__ == "__main__":
    set_seed(8855)
    os.makedirs("./chapters/chapter_4/models/RLHF", exist_ok=True)
